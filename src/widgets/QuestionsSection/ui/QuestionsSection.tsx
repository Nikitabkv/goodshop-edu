...
export const QuestionsSection = () => {
  return (
    <Container Tag={'section'} wrapperClassName={s.wrapperClassName} containerClassName={s.containerClassName}>
      ...
      <QuestionItem question={'How can I track the status of my order?'} answer={'After placing your order, you will receive a confirmation email containing your order number and a tracking link. You can also log in to your account on our website and go to the "My Orders" section to track your delivery status.'}/>
